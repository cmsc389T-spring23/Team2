...
public class TestPacManInRange extends TestCase {
  ...
  public void testPacManInRange() throws FileNotFoundException {
    ...
    Ghost ghost = frame.addGhost(new Location(4, 5), "Red", Color.red); //Creates a red ghost named "name" at location x,y
    PacMan pacman = frame.addPacMan(new Location(3, 5)); //Creates PacMan at location x, y
